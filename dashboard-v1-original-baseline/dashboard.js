...
function renderDashboard(data) {
  ...
  renderChannelFunnels(data.pages.traffic_analysis.channel_funnels);
  renderHomeSections(data.pages.traffic_analysis.home_sections);
  renderBanners(data.pages.recommendation_analysis.banners);
  renderPopups(data.pages.recommendation_analysis.popups);
  renderGuessYouLike(data.pages.recommendation_analysis.guess_you_like);
}
